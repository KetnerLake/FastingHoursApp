<script>
  ...
  let {disabled = false, email = null, oncancel, ondone, onverify} = $props();
...
<section>
  ...
  <figure>
    ...
    <div>
      <h3>Thank you!</h3>
      <p>Thank you for being a valued member of the Fasting Hours community, and for supporting future development.</p>
    </div> 
  </figure>
  ...
  <footer>
    ...
    <button {disabled} onclick={onVerifyClick} type="button">Verify</button>    
  </footer>      
